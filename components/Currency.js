        ...
        return (
            ...
            <View>
                <View style={[s.headerContainer,{backgroundColor: '#318d23'}]} >
                    <Text style={s.headerText}> Currency </Text>
                </View>
                ...
                <View style={s.contentsContainer} >
                    ...
                    <View style={s.inputContainer}>
                        <Picker
                            ...
                            <Picker.Item label="₫ VND/VN Dong" value="VND" />
                            <Picker.Item label="¥ CNY(RMB)/Chinese Yen" value="CNY" />
                            <Picker.Item label="¥ JPY/Japanese Yen" value="JPY" />
                            <Picker.Item label="₩ KRW/Korean Won" value="KRW" />
                            <Picker.Item label="€ EUR/Euro" value="EUR" /> 
                            <Picker.Item label="£ GBP/Great Britain Pound" value="GBP" />
                        </Picker>
                    ...
                    <View style={s.inputContainer}>
                        <Picker
                            ...
                            <Picker.Item label="₩ KRW/Korean Won" value="KRW" />
                            <Picker.Item label="€ EUR/Euro" value="EUR" /> 
                            <Picker.Item label="£ Pound/Englend" value="GBP" />
                        </Picker>
                        <View>
